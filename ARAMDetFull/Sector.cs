...
namespace ARAMDetFull
{
    class Sector
    {
        ...
        public void draw()
        {
            ...
            Drawing.DrawCircle(center.To3D(), 50, Color.Violet);
        }
        ...
        public Vector2 getRandomPointIn(bool rand = false)
        {
            ...
            if (enemyChampIn != null && !enemyChampIn.IsZombie && ARAMSimulator.player.IsMelee && !enemyChampIn.IsUnderHisturret())
