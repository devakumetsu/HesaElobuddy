...
namespace ARAMDetFull.Champions
{
    class Karthus : Champion
    {
        ...
        {
            Q = new Spell.Skillshot(SpellSlot.Q, 875, SkillShotType.Circular, spellSpeed: int.MaxValue, spellWidth: 160 * 2, castDelay: 750);
            W = new Spell.Skillshot(SpellSlot.W, 1000, SkillShotType.Circular, spellWidth: 100);
        ...
        public float GetTargetHealth(EnemyInfo playerInfo, int additionalTime)
        {
            ...
            var predictedhealth = playerInfo.Player.Health + playerInfo.Player.HPRegenRate * ((Core.GameTickCount - playerInfo.LastSeen + additionalTime) / 1000f);
        ...
        void RegulateEState(bool ignoreTargetChecks = false)
        {
            ...
            var minions = EntityManager.MinionsAndMonsters.GetLaneMinions(EntityManager.UnitTeam.Enemy, ObjectManager.Player.ServerPosition, E.Range);
