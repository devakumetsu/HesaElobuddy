    ...
    class Kassadin : Champion
    {
        ...
        public override void setUpSpells()
        {
            /*DFG = Utility.Map.GetMap().Type == Utility.Map.MapType.TwistedTreeline ||
                ...
                ? new Item(3188, 750) : new Item(3128, 750);*/

            Q = new Spell.Targeted(SpellSlot.Q, 650);
            W = new Spell.Active(SpellSlot.W, 150);
            E = new Spell.Skillshot(SpellSlot.E, 500, SkillShotType.Cone, 500, int.MaxValue, 10);
            R = new Spell.Skillshot(SpellSlot.R, 500, SkillShotType.Circular, 500, int.MaxValue, 150);
