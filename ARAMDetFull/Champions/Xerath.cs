...
namespace ARAMDetFull.Champions
{
    class Xerath : Champion
    {
            ...
            get
            {
                return ObjectManager.Player.HasBuff("XerathLocusOfPower2") ||
                       (ObjectManager.Player.LastCastedSpellName().Equals("XerathLocusOfPower2", StringComparison.InvariantCultureIgnoreCase) &&
                        Core.GameTickCount - ObjectManager.Player.LastCastedSpellT() < 500);
            }
        }
        ...
        public Xerath()
        {
            ...
            AIHeroClient.OnIssueOrder += AIHeroClient_OnIssueOrder;
        }
        ...
        void AIHeroClient_OnIssueOrder(Obj_AI_Base sender, GameObjectIssueOrderEventArgs args)
        {
            if (IsCastingR )
            {
                args.Process = false;
