        ...
        public static float GetRealDamage(this SpellSlot slot, Obj_AI_Base target)
        {
            ...
            switch (slot)
            {
                case SpellSlot.Q:
                    ...
                    damage = new float[] {20, 50, 80, 110, 140}[spellLevel] + 1f*Player.Instance.FlatPhysicalDamageMod;
                    break;
                ...
                case SpellSlot.E:
                    ...
                    damage = new float[] {80, 120, 160, 200, 240}[spellLevel] + 0.5f*Player.Instance.FlatMagicDamageMod;
                    break;

                case SpellSlot.R:

                    damage = new float[] {80, 120, 160}[spellLevel] + 0.5f*Player.Instance.FlatMagicDamageMod +
