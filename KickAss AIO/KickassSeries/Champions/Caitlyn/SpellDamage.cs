        ...
        public static float GetRealDamage(this SpellSlot slot, Obj_AI_Base target)
        {
            ...
            switch (slot)
            {
                ...
                case SpellSlot.W:
                    ...
                    damage = new float[] { 40, 50, 60, 70, 80 }[spellLevel] + 0.1f * Player.Instance.FlatMagicDamageMod;
                    break;

                case SpellSlot.E:

                    damage = new float[] { 70, 110, 150, 190, 230 }[spellLevel] + 0.8f * Player.Instance.FlatMagicDamageMod;
                    break;

                case SpellSlot.R:

                    damage = new float[] { 250, 475, 700 }[spellLevel] + 2f * Player.Instance.FlatPhysicalDamageMod;
                    break;
            }
