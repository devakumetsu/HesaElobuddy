        ...
        public static float GetRealDamage(this SpellSlot slot, Obj_AI_Base target)
        {
            ...
            switch (slot)
            {
                ...
                case SpellSlot.E:
                    ...
                    damage = new float[] { 85, 130, 175, 225, 275 }[spellLevel] + 1.0f * Player.Instance.FlatMagicDamageMod;
                    break;

                case SpellSlot.R:

                    damage = new float[] { 325, 450, 675 }[spellLevel] + 2.5f * Player.Instance.FlatMagicDamageMod;
                    break;
            }
