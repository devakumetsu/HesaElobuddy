        ...
        public static float GetRealDamage(this SpellSlot slot, Obj_AI_Base target)
        {
            ...
            switch (slot)
            {
                case SpellSlot.Q:
                    ...
                    damage = new float[] { 80, 135, 190, 245, 300 }[spellLevel] + 1.0f * Player.Instance.FlatMagicDamageMod;
                    break;
                ...
                case SpellSlot.E:
                    ...
                    damage = Player.Instance.GetAutoAttackDamage(target) * Player.Instance.FlatPhysicalDamageMod;
                    break;

                case SpellSlot.R:

                    damage = new float[] { 200, 375, 500 }[spellLevel] + 1.0f * Player.Instance.FlatMagicDamageMod;
                    break;
            }
